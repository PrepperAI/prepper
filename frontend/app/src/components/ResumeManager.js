...
//     data.sort((a, b) => (b.isDefault ? 1 : 0) - (a.isDefault ? 1 : 0)); // Default at top
//     setResumes(data);
//   };
...
//         `http://localhost:8000/api/upload-resume?user_id=${user.uid}`,
//         {
//           method: "POST",
//           body: formData,
//         }
...
//       setPreviewUrl(null); // Close modal if deleting the active one
//     }
//   };
